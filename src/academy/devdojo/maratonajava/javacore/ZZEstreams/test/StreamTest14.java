...
public class StreamTest14 {
    ...
    public static void main(String[] args) {
        ...
        //Encontra o anime mais caro de cada categoria, sem trabalhar com Optional(collectingAndThen()).
        //collectingAndThen(): Permite executar uma ação logo após a conclusão de outro coletor.
        ...
        //Encontra o anime mais caro de cada categoria, sem trabalhar com Optional (Outra forma).
