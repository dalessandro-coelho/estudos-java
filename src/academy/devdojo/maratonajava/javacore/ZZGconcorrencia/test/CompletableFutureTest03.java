...
public class CompletableFutureTest03 {
    public static void main(String[] args) {
        ...
        searchPricesAsysncCompletableFuture(storeServiceDeprecated);
    }

    private static void searchPricesAsysncCompletableFuture(StoreServiceDeprecated storeService) {
        ...
        //Envolver a chamada de um metodo síncrono dentro de um CompletableFuture.supplyAsync(),
        //permite que a aplicação continue rodando enquanto a tarefa pesada é processada em outra thread.
