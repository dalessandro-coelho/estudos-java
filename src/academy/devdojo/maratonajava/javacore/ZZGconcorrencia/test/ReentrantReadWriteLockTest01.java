...
public class ReentrantReadWriteLockTest01 {
    public static void main(String[] args) {
        //ReadWriteLock: Ele mantém um par de locks associados,onde um para operações de leitura e outro para escrita.
        //Lock de Leitura (readLock): Pode ser adquirido por múltiplas threads simultaneamente, desde que ninguém esteja a escrever no momento.
        //Lock de Escrita (writeLock): É exclusivo. Apenas uma thread pode escrever de cada vez, e enquanto ela escreve, ninguém (nem leitores, nem outros escritores) pode aceder ao recurso.
