...
public class ComportamentoPorParametroTest01 {
    ...
    //Parametrizar Comportamento -> Significa passar uma ação (um comportamento) como parâmetro para um metodo, ou seja, em vez de passar só dados,passa o que o metodo deve fazer.
